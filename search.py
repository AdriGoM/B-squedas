...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Se han expandido: " , count , " nodos")
            return node
...
def bab_first_graph_search(problem):
    return graph_search(problem, PriorityQueue())

def babsubestimation_first_graph_search(problem):
    return graph_search(problem, Subestimation(problem))
